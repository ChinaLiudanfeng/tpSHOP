            ...
            <div class="mem_tit" >收货地址</div>
              <div style="height:450px;border: 1px solid #eaeaea;overflow: auto">
                <?php if(is_array($addressInfo) || $addressInfo instanceof \think\Collection || $addressInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $addressInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
    			       <div class="address">
                	<div class="a_close"><a href="javascript:;" class="del" address_id="<?php echo htmlentities($v['address_id']); ?>"><img src="/static/index/images/a_close.png" /></a></div>
                	<table border="0" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="right" width="80">收货人姓名：</td>
                        <td><?php echo htmlentities($v['address_name']); ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><?php echo htmlentities($v['address_detail']); ?></td>
                      </tr>
                      <tr>
                        <td align="right">手机：</td>
                        <td><?php echo htmlentities($v['address_tel']); ?></td>
                      </tr>
                    </table>
                    ...
                    <p align="right">
                      ...
                      <?php else: ?>
                        <a href="javascript:;" style="color:#ff4e00;" class="default" address_id="<?php echo htmlentities($v['address_id']); ?>">设为默认</a>&nbsp; &nbsp; &nbsp; &nbsp; 
                      <?php endif; ?>
                      <a href="<?php echo url('addressEdit'); ?>?address_id=<?php echo htmlentities($v['address_id']); ?>" style="color:#ff4e00;">编辑</a>&nbsp; &nbsp; &nbsp; &nbsp; 
                    </p>
                </div>
           ...
           layui.use('layer',function(){
            ...
            $(document).on('click','#sb',function(){
              ...
              if(province==0||city==0||area==0){
                ...
                $.post(
                  "<?php echo url('Address/addressAdd'); ?>",
