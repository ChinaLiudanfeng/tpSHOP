        ...
        <div class="fresh_mid">
            <ul>
                ...
                <li>
                    ...
                    <div class="img"><a href="<?php echo url('Goods/product'); ?>?goods_id=<?php echo htmlentities($v['goods_id']); ?>"><img src="/uploads1/<?php echo htmlentities($v['goods_img']); ?>" width="185" height="155" /></a></div>
                </li>   
                <?php endforeach; endif; else: echo "" ;endif; ?>                                                          
            </ul>
        </div>
...
<h2 align="center" style="color:red" id="h2">点击加载</h2>
<script type="text/javascript">
    $('#h2').click(function(){
        var _this = $(this),
        cate_id = _this.prev().attr('cate_id'),
        floor_num = parseInt(_this.prev().find('span[class="floor_num"]').text());
        $.post(
            "<?php echo url('getNextFloor'); ?>",
