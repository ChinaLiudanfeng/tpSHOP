            ...
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              <tr height="35">
                <td style="font-size:18px;">
                	感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font color="#ff4e00"><?php echo htmlentities($info['order_no']); ?></font>
                </td>
              </tr>
              <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                	您选定的配送方式为: <font color="#ff4e00">申通快递</font>； &nbsp; &nbsp;您选定的支付方式为: 
                		...
                		<?php if($info['pay_type']==1): ?>
                			<font color="#ff4e00">支付宝</font>
                		<?php elseif($info['pay_type']==2): ?>
                			<font color="#ff4e00">微信</font>
                		<?php else: ?>
                			<font color="#ff4e00">货到付款</font>
                		<?php endif; ?>
                	
                	； &nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥<?php echo htmlentities($info['order_amount']); ?></font>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                	<div class="btn_u" style="margin:0 auto; padding:0 20px; width:120px;">
                		<?php if($info['pay_type']==1): ?>
                			<a href="<?php echo url('Order/alipay'); ?>?order_id=<?php echo htmlentities($info['order_id']); ?>">立即使用支付宝支付</a>
                		<?php elseif($info['pay_type']==2): ?>
                			<a href="#">立即使用微信支付</a>
                		<?php endif; ?>
