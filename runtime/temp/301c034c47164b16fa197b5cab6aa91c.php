<?php /*a:6:{s:80:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\goods\product.html";i:1559205006;s:86:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\layout\layout_index.html";i:1557815671;s:80:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\public\header.html";i:1557391872;s:80:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\public\sousuo.html";i:1557391901;s:78:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\public\menu.html";i:1557296439;s:80:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\public\footer.html";i:1556178699;}*/ ?>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<script type="text/javascript" src="/static/index/js/lrscroll_1.js"></script>
                        ...
                        <script src="/static/index/js/ShopShow.js"></script>
...
<div class="soubg">
	<div class="sou">
        ...
        <span class="fr">
            ...
            <?php else: ?>
                <span class="fl"><a href="<?php echo url('member/index'); ?>"><?php echo htmlentities(app('session')->get('info.account')); ?></a>&nbsp;<a href="<?php echo url('login/logout'); ?>">退出</a></span>
            <?php endif; ?>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="menu_bg">
	<div class="menu">
        ...
        <!--End 商品分类详情 End-->                                                     
    	<ul class="menu_r">
            <li><a href="<?php echo url('Goods/index'); ?>">全部商品</a></li>
            <?php if(is_array($nav) || $nav instanceof \think\Collection || $nav instanceof \think\Paginator): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$nav): $mod = ($i % 2 );++$i;?>
                <li><a href="<?php echo url('goods/index'); ?>?cate_id=<?php echo htmlentities($nav['cate_id']); ?>"><?php echo htmlentities($nav['cate_name']); ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS">
                <a href="/uploads1/<?php echo htmlentities($goodsInfo['goods_img']); ?>" title="Images" class="MagicZoom" id="MagicZoom">
                    <img src="/uploads1/<?php echo htmlentities($goodsInfo['goods_img']); ?>" width="390" height="390" />
                </a>
            </div>
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
                本店价格：<b>￥<?php echo htmlentities($goodsInfo['goods_price']); ?></b><br />
                消费积分：<span>28R</span>&ensp;&ensp;&ensp;库存:<span><?php echo htmlentities($goodsInfo['goods_num']); ?></span>
            </div>
            ...
            <div class="des_join">
                <div class="j_nums">
                    <input type="text" value="1" class="n_ipt" id="value" maxNum="<?php echo htmlentities($goodsInfo['goods_num']); ?>"/>
                    <input type="button" value="" class="n_btn_1" id="on" />
                    <input type="button" value="" class="n_btn_2" id="out" />
                </div>
                <!-- <span class="fl"><a onclick="ShowDiv_1('MyDiv1','fade1')"><img src="/static/index/images/j_car.png" /></a></span> -->
                <span class="fl"><a href="javascript:;" id="cart"><img src="/static/index/images/j_car.png" /></a></span>
            </div>            
        </div>    
                ...
                <form id="myform">
                    <table>
                        <tr>
                            ...
                            <td>匿名用户</td>
                            <?php else: ?>
                            <td><?php echo htmlentities($user_name['user_email']); ?></td>
                            <?php endif; ?>
                        </tr>
                        <tr>
                            <td>邮箱</td>
                        ...
                        <tr>
                            ...
                            <td><input type="submit" value="发布评论"></td>
                        </tr>
                    </table>
                </form>
                <script type="text/javascript">
                    ...
                    $('#myform').submit(function(){
                        ...
                        var reg = /^\w{5,}@163|159\.com$/;
                        if(!reg.test(user_email)){
                            alert('邮箱格式不正确');
                            return false;
                        }
                        $.post(
                            "<?php echo url('comment'); ?>",
                            {user_email:user_email,c_content:c_content,user_code:user_code,goods_id:goods_id},
                            function(msg){
                                alert(msg.font);
                                if(msg.err==1){
    ...
    <input type="hidden" goods_id="<?php echo htmlentities($goodsInfo['goods_id']); ?>" id="goods_id">
        ...
        <div class="white_d">
            ...
            <div class="notice_c">
                ...
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                  ...
                  <tr height="50" valign="bottom">
                    <td>&nbsp;</td>
                    <td><a href="<?php echo url('Cart/cartList'); ?>" class="b_sure">去购物车结算</a><a href="javascript:;" onclick="history.go(0)" class="b_buy">继续购物</a></td>
                  </tr>
                </table>
 ...
 <script type="text/javascript">
    layui.use(['layer'],function(){
        ...
        $('#on').click(function(){
            ...
            var maxNum = parseInt($("#value").attr('maxNum'));
            if(value >= maxNum){
                $("#value").val(maxNum);
                // return false;
            }else{
            ...
            $.post(
                ...
                function(msg){
                    if(msg.err==1){
                        ...
                        layer.msg(msg.msg,{icon:msg.icon,time:2000});
                    }
                },
                'json'
            );
