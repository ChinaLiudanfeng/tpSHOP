<?php /*a:6:{s:87:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\address\address_edit.html";i:1558354443;s:86:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\layout\layout_index.html";i:1557815671;s:80:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\public\header.html";i:1557391872;s:84:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\public\member_top.html";i:1557134209;s:85:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\public\member_left.html";i:1558160110;s:80:"F:\phpStudy\PHPTutorial\WWW\mouth5\tp5\application\index\view\public\footer.html";i:1556178699;}*/ ?>
      ...
      <div class="left_m_t t_bg1">订单中心</div>
        <ul>
          <li><a href="Member_Order.html">我的订单</a></li>
            <li><a href="<?php echo url('Address/addressList'); ?>">收货地址</a></li>
            <li><a href="#">缺货登记</a></li>
            <li><a href="#">跟踪订单</a></li>
        </ul>
    </div>
		...
		<div class="m_right">
            ...
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td colspan="3" style="font-family:'宋体';">
                	<select class="province" name="province">
                      <option value="<?php echo htmlentities($a['id']); ?>" selected="selected"><?php echo htmlentities($a['name']); ?></option>
                    ...
                    <select class="province" name="city">
                      <option value="<?php echo htmlentities($b['id']); ?>" selected="selected"><?php echo htmlentities($b['name']); ?></option>
                    </select>
              ...
              <tr>
                ...
                <td style="font-family:'宋体';"><input type="text" class="add_ipt" name="address_name" value="<?php echo htmlentities($info['address_name']); ?>" />（必填）</td>
                <td align="right">手机号</td>
                <td style="font-family:'宋体';"><input type="text" class="add_ipt" name="address_tel" value="<?php echo htmlentities($info['address_tel']); ?>" />（必填）</td>
              </tr>
              <tr>
                <td align="right">详细地址</td>
                <td style="font-family:'宋体';"><input type="text" class="add_ipt" name="address_detail" value="<?php echo htmlentities($info['address_detail']); ?>" />（必填）</td>
                <td align="right">邮政编码</td>
                <td style="font-family:'宋体';"><input type="text" class="add_ipt" name="address_mail" value="<?php echo htmlentities($info['address_mail']); ?>" /></td>
              </tr>
              <tr>
                <td colspan="4">
           	...
           	<p align="right">
              <input type="hidden" name="address_id" value="<?php echo htmlentities($info['address_id']); ?>">
           ...
           layui.use('layer',function(){
            ...
            $(document).on('click','#sb',function(){
              ...
              if(province==0||city==0||area==0){
                ...
                $.post(
                  "<?php echo url('Address/addressUpd'); ?>",
                  ...
                  function(msg){
                    layer.msg(msg.msg,{icon:msg.icon,time:1000},function(){
                      if(msg.err == 1){
                        location.href = "<?php echo url('Address/addressList'); ?>";
                      }
                    });
                  },
                  'json'
            ...
            $(document).on('click','.default',function(){
              ...
              $.post(
                "<?php echo url('Address/addressSetDefault'); ?>",
