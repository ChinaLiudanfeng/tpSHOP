    ...
    <div class="content mar_20">
    	<div class="l_history">
        	...
        	<ul>
            	...
            	<li>
                    <div class="img"><a href="#"><img src="/uploads1/<?php echo htmlentities($v['goods_img']); ?>" width="185" height="162" /></a></div>
                	<div class="name"><a href="#"><?php echo htmlentities($v['goods_name']); ?></a></div>
                    <div class="price">
                    	<font>￥<span><?php echo htmlentities($v['goods_price']); ?></span></font> &nbsp; 18R
                    </div>
                </li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
        	</ul>
